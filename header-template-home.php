...
<html <?php language_attributes(); ?>>
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" class="<?php echo implode(' ', get_body_class()); ?>">
        ...
        ?>
        <?php $image_attributes = wp_get_attachment_image_src( get_theme_mod( 'default_header_bck' ), 'large' ); ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <h1 class="brand-heading"><?php echo get_theme_mod( 'hometitle', __( 'Page Sample', 'wowaries' ) ); ?></h1>
                            <p class="intro-text"><?php echo get_theme_mod( 'homesubtitle', __( 'Description', 'wowaries' ) ); ?></p>
